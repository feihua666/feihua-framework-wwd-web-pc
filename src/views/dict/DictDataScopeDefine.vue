<template>
  <div class="fh-page-wrapper">
    ...
    <el-form-item label="字典数据范围" prop="type">
      <self-dict-select v-model="form.type" type="dict_dataScope" :show-none="false"></self-dict-select>
    </el-form-item>
    <el-form-item>
  ...
  export default {
    ...
    methods: {
      loadData () {
        ...
        this.$http.get('/base/dataScope/' + this.dataScopeId + '/dictDataScope/define')
