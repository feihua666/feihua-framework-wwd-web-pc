    ...
    <el-container class="fh-page-wrapper">
      <el-aside width="200px"  class="fh-tree-aside">
        <el-scrollbar style="height: 100%;" wrapStyle="height:100%;overflow:auto;" >
          <area-tree ref="lefttree" class="fh-tree-aside-panel" v-on:nodeClick="treeNodeClick"></area-tree>
         </el-scrollbar>
      </el-aside>
      <el-main>
        <el-collapse value="1">
  ...
  export default {
    ...
    methods: {
      ...
      editTableRowClick (index, row) {
        this.$utils.loadDataControl.add('AreaEditLoadData=true')
      ...
      deleteTableRowClick (index, row) {
        ...
        this.$confirm('确定要删除吗, 是否继续?', '提示', {
          ...
          self.$http.delete('/base/area/' + row.id)
            .then(function (response) {
